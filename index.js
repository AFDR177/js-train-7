...
function createSymbolForKey(key) {
  ...
  // Symbol.for() шукає символ в глобальному реєстру символів. Якщо символ з таким ключем вже існує, він повертає його,
...
//     let value = category.name[currentIndex];
//     // Збільшимо currentIndex на одиницю
...
//     //       : { done: true };
//     //..
//   } else if (currentIndex >= category.length) {
//     return myObject;
//   }
